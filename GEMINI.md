...
**Key Features:**
*   **Role-Based Access Control:** Admin, Manager, Supervisor, Driver.
...
*   **Driver Management:** Profiles, history, and financial "pockets" (salary, loans, allowances).
*   **Financial Ledger:** Income and expense tracking, associated with trips.
*   **Dashboards:** Role-specific views for Drivers and Managers.
